...
Having classified first using Paragraph features through a Random Forest model, I then used a Random Forest model with the following features to further classify:
